...
<div class="hulahoot-admin">
    <div class="page-header hulahoot-page-header">
        <h1>{_p var='hulahoot_delete_profile_type'}</h1>
    </div>
    ...
    <p>{_p var='hulahoot_confirm_delete_profile_type' name=$type_name}</p>

    <form method="post" action="/admincp/hulahoot/profiletype/delete?id={$type.profile_type_id}">
