...
<div class="hulahoot-admin">
    <div class="hulahoot-swess-nav">
        <a href="/admincp/hulahoot/swess/whitelist" class="btn btn-default btn-sm active">{_p var='hulahoot_admin_swess_whitelist'}</a>
    ...
    <div class="page-header hulahoot-page-header">
        <h1>{_p var='hulahoot_admin_swess_whitelist'}</h1>
